...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Sambacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed1.sambacoin.info", "seed1.sambacoin.info"},
    {"seed2.sambacoin.info", "seed2.sambacoin.info"},
    {"seed.sambacoin.info", "seed.sambacoin.info"},
    {"seed3.sambacoin.info", "seed3.sambacoin.info"},
    {"seed4.sambacoin.info", "seed4.sambacoin.info"},
    {"seed5.sambacoin.info", "seed5.sambacoin.info"},
    {"seed6.sambacoin.info", "seed6.sambacoin.info"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"seed1-testnet.sambacoin.info", "seed1-testnet.sambacoin.info"},
    {"seed2-testnet.sambacoin.info", "seed2-testnet.sambacoin.info"},
    {"seed-testnet.sambacoin.info", "seed-testnet.sambacoin.info"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Sambacoin is probably already running."), addrBind.ToString().c_str());
        else
